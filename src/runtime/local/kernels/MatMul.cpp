...
int32_t launch_dot(const int32_t n, const int32_t *x, const int32_t incx,
    ...
    Eigen::Map<const Eigen::Vector<int32_t, Eigen::Dynamic>, Eigen::Unaligned>
        eigenX(x, n);
    Eigen::Map<const Eigen::Vector<int32_t, Eigen::Dynamic>, Eigen::Unaligned>
        eigenY(y, n);
...
int64_t launch_dot(const int32_t n, const int64_t *x, const int32_t incx,
    ...
    Eigen::Map<const Eigen::Vector<int64_t, Eigen::Dynamic>, Eigen::Unaligned>
        eigenX(x, n);
    Eigen::Map<const Eigen::Vector<int64_t, Eigen::Dynamic>, Eigen::Unaligned>
        eigenY(y, n);
    return eigenX.dot(eigenY);
    ...
    if (transa) {
        auto e_A =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                A, m, n, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, n))
                .transpose();
...
launch_gemm<int32_t>(bool transa, bool transb, const int32_t m, const int32_t n,
    ...
    if (transa && transb) {
        auto eigenA =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                A, k, m, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, m))
                .transpose();
        auto eigenB =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                B, n, k, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, k))
                .transpose();
        auto eigenC =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                C, n, m, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, m));
        ...
        auto eigenA =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                A, m, k, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, k));
        auto eigenB =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                B, n, k, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, k))
                .transpose();
        auto eigenC =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                C, m, n, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, n));
        eigenC.noalias() = eigenA * eigenB;
    } else {
        auto eigenA =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
        ...
        auto eigenB =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                B, k, n, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, n));
        auto eigenC =
            Eigen::Matrix<int32_t, Eigen::Dynamic, Eigen::Dynamic>::Map(
                C, m, n, Eigen::Stride<Eigen::Dynamic, Eigen::Dynamic>(1, n));
        eigenC.noalias() = eigenA * eigenB;
...
void MatMul<DenseMatrix<VT>, DenseMatrix<VT>, DenseMatrix<VT>>::apply(
    ...
    if (nr1 == 1 && nc2 == 1) { // Vector-Vector
        ...
        res->set(
            0, 0,
            launch_dot(nc1, A, 1, B,
                       rhs->isView() ? (transb ? 1 : rhs->getRowSkip()) : 1));
