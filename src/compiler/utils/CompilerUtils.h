...
struct CompilerUtils {
  ...
  public:
     ...
     * derived types DenseMatrix et al.
        ...
        if (t.isF64())
            ...
            if (generalizeToStructure)
                ...
                case mlir::daphne::MatrixRepresentation::Dense:
                    return "DenseMatrix_" +
                           mlirTypeToCppTypeName(matTy.getElementType(), false);
            ...
            return "Handle_" + mlirTypeToCppTypeName(handleTy.getDataType(),
            ...
            return "StridedMemRefType_" +
                   mlirTypeToCppTypeName(memRefType.getElementType(), false) +
                   "_2";
        }
