...
class VectorizedPipelineOpLowering
  ...
  public:
    ...
    matchAndRewrite(daphne::VectorizedPipelineOp op, OpAdaptor adaptor,
        ...
        callee << "__"
               << CompilerUtils::mlirTypeToCppTypeName(operandType, true);
        ...
        newOperands.push_back(
            convertToArray(loc, rewriter, rewriter.getI64Type(),
                           rowsOperands.take_front(numOutputs)));
        callee << "__"
               << CompilerUtils::mlirTypeToCppTypeName(
                      rewriter.getIntegerType(64, true));
        ...
        newOperands.push_back(
            convertToArray(loc, rewriter, rewriter.getI64Type(),
                           colsOperands.take_front(numOutputs)));
        ...
        newOperands.push_back(
            convertToArray(loc, rewriter, rewriter.getI64Type(), splitConsts));
        ...
        newOperands.push_back(convertToArray(
            loc, rewriter, rewriter.getI64Type(), combineConsts));
        ...
        newOperands.push_back(
            convertToArray(loc, rewriter, ptrPtrI1Ty, func_ptrs));
