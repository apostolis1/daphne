 ...
 * checks.
 */
TEMPLATE_TEST_CASE("ExtractCol - Frame", TAG_KERNELS, int64_t,
...
TEMPLATE_TEST_CASE("ExtractCol - Frame error handling", TAG_KERNELS,
...
TEMPLATE_TEST_CASE("ExtractCol - Dense Matrix", TAG_KERNELS, int64_t,
                   double) { // NOLINT(cert-err58-cpp)
    using VT = TestType;
...
TEMPLATE_TEST_CASE("ExtractCol - Dense Matrix error handling", TAG_KERNELS,
                   int64_t) { // NOLINT(cert-err58-cpp)
    using VT = TestType;
    using DT = DenseMatrix<VT>;
